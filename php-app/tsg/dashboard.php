...
<div class="card logs-card" style="position:relative; margin-top: 1.5rem; padding: 1.5rem;" id="assignedCard">
    ...
    <div class="detail-overlay hidden" id="assignedDetailOverlay">
        <div class="detail-box">
            ...
            <!-- Reassign personnel (shown only when status is NOT Resolved) -->
            <form method="POST" action="<?= base_url('actions/do_assign_personnel.php') ?>" style="margin-top:1rem" id="aReassignForm">
                <input type="hidden" name="report_id" id="aAssignReportId">
                <div class="form-group">
                    <label class="form-label">Reassign Personnel</label>
                    <select class="form-control" name="personnel_id" id="aPersonnelSelect" required>
...
function openAssignedDetail(r) {
    ...
    document.getElementById('aReassignForm').style.display      = isResolved ? 'none' : '';
